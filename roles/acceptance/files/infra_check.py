...
st, body = http("http://localhost:8080/")
check("demo app direct :8080", st == 200 and "infra-demo" in body)
st, body = http("http://localhost/app/")
check("demo app via nginx /app/", st == 200 and "infra-demo" in body)
